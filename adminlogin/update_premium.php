...
if(isset($_POST['update'])){
  ...
  //   $filesize = $_FILES["file"]["size"] < 5 * 1024 ;
    ...
    $query = "update garbageinfo_premium set name='$name',mobile='$mobile',email='$email',location='$location',locationdescription='$locationdescription',file= '$file',date='$date' WHERE Id='$id'" ;
    ...
    if($data) {
       ...
       header("Location: http://localhost/wms3/adminlogin/welcome_premium.php", TRUE, 301);
       exit();
