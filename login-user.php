...
<div class="header">
    ...
    <p>Waste Management system | 2023 | 
         ...
         <a href="adminsignup/adminlogin.php"> <i class="fa fa-lock" aria-hidden="true"> Login As Govt. Admin</i></a>
         <a href="adminsignup/adminlogin_private.php"> <i class="fa fa-lock" aria-hidden="true"> Login As Private Admin</i></a>
