...
if(isset($_POST['update'])){
  $Id= $_POST['id'];
   ...
   $statusdesc = $_POST['statusdesc'];
	...
	$query = "update garbageinfo SET status = '$status', statusdesc = '$statusdesc' WHERE Id = '$Id'";
    ...
    if($data) {
       ...
       header("Location: http://localhost/wms3/adminsignup/index.php", TRUE, 301);
       exit();
	...
	<div class="row">
		<div class="col-md-3">
			<div class="contact-info">
				...
				<h2>Edit Status</h2>
				<h4>Inform Users their requested complain is Handle!</h4>
			</div>
		</div>
		<div class="col-md-9">
