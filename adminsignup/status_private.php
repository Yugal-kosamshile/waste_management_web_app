...
if(isset($_POST['update'])){
  $Id= $_POST['id'];
   ...
   $statusdesc = $_POST['statusdesc'];
    ...
    $query = "update garbageinfo_paid set status= '$status',statusdesc = '$statusdesc' WHERE Id= '$Id' " ;
    ...
    if($data) {
       ...
       header("Location: http://localhost/wms3/adminsignup/index_private.php", TRUE, 301);
       exit();
...
<body>
   ...
   <form method="post" action="status_private.php"enctype="multipart/form-data">
