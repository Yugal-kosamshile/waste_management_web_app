...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style='background-color:#37517e'>
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                ...
                <li>
                    <a href="index_premium.php"><i class="fa fa-fw fa-paper-plane-o"></i> Premium Complaints</a>
                </li>
                <li>
   ...
   $query = "select * from garbageinfo_paid";
   ...
   if($total!=0) {
     ...
     echo "
           <tr class='panel panel'>
               ...
               <td><a href = 'admindelete_paid.php?i=$result[id] 'class='btn btn-danger'>Delete</a></td>
              <td> <a href = 'status_private.php?i=$result[id]&s=$result[status] 'class='btn btn-success'>Status</a></td>
